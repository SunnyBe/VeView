...
import com.veview.veview_sdk.utils.EmptyTestService
...
class AndroidAudioProviderTest {
    ...
    fun setup() {
        ...
        try {
            ...
            audioProvider = AndroidAudioCaptureProvider.create(
                context = service,
    ...
    fun startRecording_and_stopRecording_creates_a_valid_nonEmpty_wavFile() = runBlocking {
        ...
        val (audioFile, _) = audioProvider.startRecording(fileName, config)
